...
planning, but the approach relies on fixed gait sequences. 
...
\hl{The chapter needs to draw a conclusion from all the related work to mention that there is a gap here to be addressed and that is what we're working on in the rest of the report.}
