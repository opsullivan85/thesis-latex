...
\label{sec:background-greedy-and-heuristic-footstep-planners}
...
While these works demonstrate the potential of greedy methods, none
support both dynamically \hl{unstable} and non-gaited footstep
generation. \hl{Notably, some prior methods already discussed}—such
as ContactNet \cite{bratta_contactnet_2024}, DeepLoco
\cite{peng_deeploco_2017}, and Villarreal et al.
\cite{villarreal_fast_2019}—\hl{also incorporate greedy elements in
their pipelines.}
