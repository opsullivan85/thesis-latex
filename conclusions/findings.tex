...
baseline method's performance degrades rapidly above \expLowestSpeed
...
conditions, with mean swing duration of \resGaitNetMeanSwingDuration
and standard deviation of \resGaitNetSTDSwingDuration during
evaluation. The system selects longer swing durations on more
challenging terrain
...
Cost-Ablated-GaitNet achieves a \resCostAblatedSurvivalRate survival
rate, representing an 8.3 percentage point improvement over the
standard formulation. This result challenges conventional wisdom
about hybrid architectures and suggests that learned heuristics from
perception modules may constrain rather than enhance downstream
reinforcement learning. The correlation analysis
