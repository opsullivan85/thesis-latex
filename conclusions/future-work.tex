...
More comparisons need to be performed to evaluate the performance of
GaitNet to other planners. In doing this, a comparison with a RL
trained variant of ContactNet \cite{bratta_contactnet_2024} would
be valuable.
