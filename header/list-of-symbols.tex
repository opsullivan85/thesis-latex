\chapter*{\hl{List of Symbols}}

\blfootnote{Note: A symbol defined with a subscript $i$, but displayed without
  it indicates the concatenation of all $i$ elements, e.g.
  $\mathbf c =
