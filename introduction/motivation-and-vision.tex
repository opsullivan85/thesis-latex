...
environments that are \hl{inaccessible or hazardous to wheeled and
...
as \textit{contact planning}. Unlike periodic gait patterns suitable for flat
...
feasible contact points within tight temporal constraints. \hl{Existing
