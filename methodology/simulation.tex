...
\begin{figure}[H]
  ...
  \caption{Block diagram showing the programming tasks computed on
    ...
    using NVIDIA     Isaac Lab on the GPU, while the robot MPCs are run
...
\begin{itemize}
  ...
  \item Custom terrain\textemdash A grid of 12$\times$12 sub-terrains
    ...
    void density varies from approximately 0\% to 40\%. The quantity
    of     terrain is limited by GPU memory.
\end{itemize}
