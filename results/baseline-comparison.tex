...
\expBenchmarkDuration each. An episode is considered successful if
the robot is able to complete the full \expBenchmarkDuration without
terminating according to the conditions described in
...
\hl{You should explain what success and failure mean and how they are measured here. You kind of mention it but you need to elaborate and clarify. Also, you need to clarify what you mean by increasing the "Terrain Difficulty". }
