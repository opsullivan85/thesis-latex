...
in the experiments described in \autoref{sec:results-baseline-comparison}.
The distribution shows that GaitNet effectively optimizes the swing duration
from the nominal value of 0.2\,s. The model also learns to select different
swing durations for the front and rear legs.

\autoref{fig:data-swing-duration-histogram-easy-vs-hard} compares the
swing duration distributions on easy (0\% terrain difficulty) and hard
(40\% terrain difficulty) terrains. On harder terrain, the model
