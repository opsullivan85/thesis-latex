...
nominal value of 0.2\,s. The model also learns to select different
swing durations for the front and rear legs.

\autoref{fig:data-swing-duration-histogram-easy-vs-hard} compares the
swing duration distributions on easy (\expLowestDifficulty terrain
difficulty) and hard (\expHighestDifficulty terrain difficulty)
terrains. On harder terrain, the model selects slightly longer swing
durations on average, indicating a more cautious gait. This
adaptability demonstrates GaitNet's ability to modify its gait based
...
\begin{figure}
  ...
  \begin{minipage}[t]{0.45\textwidth}
    ...
    (\expLowestDifficulty versus \expHighestDifficulty terrain difficulty).}
