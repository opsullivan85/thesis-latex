...
swing duration distributions on easy (0\% terrain difficulty) and
hard (40\% terrain difficulty) terrains. On harder terrain, the model
selects slightly longer swing durations on average, indicating a more
cautious gait. This adaptability demonstrates GaitNet's ability to
modify its gait based on terrain difficulty.
...
\begin{figure}
  ...
  \begin{minipage}[t]{0.45\textwidth}
    ...
    (0\% versus 40\% terrain difficulty).}
