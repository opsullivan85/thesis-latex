...
with a fixed swing duration. In the GaitNet formulation described previously,
the model explicitly outputs a swing duration to use for every action.
The corresponding swing duration is then used for the chosen action.
For this ablation, we ignore the swing duration output of GaitNet and directly
use a fixed value, \expDurationAblatedSwingDuration{}. This value was chosen
because it is roughly the mean step duration used by GaitNet. This will provide information
about how important the variable swing duration is for this use case.
...
% \hl{What other conclusions can you
% make from this? Why is GaitNet not reacting to this seemingly important factor?}
