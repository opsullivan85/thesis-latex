...
with a fixed swing duration. \hl{was the swing duration relaxed/unconstrained in the standard GaitNet? Mention it here.}
...
duration to a constant \expDurationAblatedSwingDuration. The training
process is identical to that of the standard GaitNet model, ensuring
a fair comparison. The performance of both models is then evaluated
using the same metrics outlined in
...
of environments and conditions. \hl{What other conclusions can you make from this? Why is GaitNet not reacting to this seemingly important factor?}
